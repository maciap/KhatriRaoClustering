...
if __name__ == "__main__": 
    ...
    start = time.time()
    loss_pp, Bs_pp, labels_pp = KRkmeansExperimentsLib.run_pp(X, n_clusters1, n_clusters2, n_reps=n_reps)
    ...
    start = time.time()
    l_lowes_kr_sum, Bs_kr_sum, best_assignments_sum = KRkmeansExperimentsLib.run_kr_k_means(X, n_clusters1, n_clusters2, n_reps=n_reps, init_type = "random", operator = "sum") 
    ...
    start = time.time()
    l_lowes_kr_prod, Bs_kr_prod , best_assignments_kr_prod = KRkmeansExperimentsLib.run_kr_k_means(X, n_clusters1, n_clusters2, n_reps=n_reps, init_type = "random", operator = "product") 
