...
from KhatriRaoClustering.kr_k_means_time_efficient import KrKMeans as KrKMeansTE
from KhatriRaoClustering.kr_k_means_space_efficient import KrKMeans as KrKMeansSE
from KhatriRaoClustering.kr_k_means_p_sets import KrKMeans as KrKMeansPsets
...
def main() -> None:
    ...
    parser.add_argument("--standardize", action="store_true", help="If set, standardize features")
